    ...
    public static class Library extends StructureStrongholdPieces.Stronghold
        {
            ...
            static
            {
                ChestGenHooks.init(STRONGHOLD_LIBRARY, strongholdLibraryChestContents, 1, 5);
                ChestGenHooks.addItem(STRONGHOLD_LIBRARY, new WeightedRandomChestContent(new net.minecraft.item.ItemStack(Items.enchanted_book, 1, 0), 1, 5, 2));
            }
