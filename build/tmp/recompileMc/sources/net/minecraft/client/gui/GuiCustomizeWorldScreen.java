        ...
        if (button.enabled)
        {
            switch (button.id)
            {
                ...
                case 301:
                    ...
                    {
                        GuiPageButtonList.GuiEntry guientry = this.field_175349_r.func_178070_d(i);
    ...
    private void func_175327_a(float p_175327_1_)
    {
        ...
        if (gui instanceof GuiTextField)
        {
            ...
            if (f2 != null)
            {
                ...
                String s = this.func_175330_b(guitextfield.func_175206_d(), f2.floatValue());
