...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List call()
    {
        ...
        {
            return Lists.newArrayList(new String[] {"Minecraft 1.8 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[]{Integer.valueOf(blockpos.getX() & 15), Integer.valueOf(blockpos.getY() & 15), Integer.valueOf(blockpos.getZ() & 15)})});
        }
        else
        {
            ...
            switch (GuiOverlayDebug.SwitchEnumFacing.field_178907_a[enumfacing.ordinal()])
            {
                case 1:
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(blockpos))
            {
                ...
                arraylist.add("Light: " + chunk.setLight(blockpos, 0) + " (" + chunk.getLightFor(EnumSkyBlock.SKY, blockpos) + " sky, " + chunk.getLightFor(EnumSkyBlock.BLOCK, blockpos) + " block)");
                ...
                arraylist.add(String.format("Local Difficulty: %.2f (Day %d)", new Object[] {Float.valueOf(difficultyinstance.func_180168_b()), Long.valueOf(this.mc.theWorld.getWorldTime() / 24000L)}));
            }
