...
public class GlStateManager
{
    ...
    {
        GlStateManager.TexGenCoord texgencoord = texGenCoord(p_179149_0_);

        if (p_179149_1_ != texgencoord.field_179066_c)
        {
            texgencoord.field_179066_c = p_179149_1_;
            GL11.glTexGeni(texgencoord.field_179065_b, GL11.GL_TEXTURE_GEN_MODE, p_179149_1_);
        }
    }
    ...
    public static void deleteTexture(int p_179150_0_)
    {
        ...
        GlStateManager.TextureState[] atexturestate = textureState;
        int j = atexturestate.length;

        for (int k = 0; k < j; ++k)
        {
            GlStateManager.TextureState texturestate = atexturestate[k];

            if (texturestate.textureName == p_179150_0_)
            {
