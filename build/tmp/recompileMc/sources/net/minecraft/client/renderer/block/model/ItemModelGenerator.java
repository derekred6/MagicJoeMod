...
public class ItemModelGenerator
{
    ...
    public ModelBlock makeItemModel(TextureMap textureMapIn, ModelBlock blockModel)
    {
        ...
        else
        {
            ...
            return new ModelBlock(arraylist, hashmap, false, false, new ItemCameraTransforms(blockModel.getThirdPersonTransform(), blockModel.getFirstPersonTransform(), blockModel.getHeadTransform(), blockModel.getInGuiTransform()));
        }
    }
    ...
    {
        HashMap hashmap = Maps.newHashMap();
        hashmap.put(EnumFacing.SOUTH, new BlockPartFace((EnumFacing)null, p_178394_1_, p_178394_2_, new BlockFaceUV(new float[] {0.0F, 0.0F, 16.0F, 16.0F}, 0)));
        hashmap.put(EnumFacing.NORTH, new BlockPartFace((EnumFacing)null, p_178394_1_, p_178394_2_, new BlockFaceUV(new float[] {16.0F, 0.0F, 0.0F, 16.0F}, 0)));
        ArrayList arraylist = Lists.newArrayList();
        ...
        arraylist.addAll(this.func_178397_a(p_178394_3_, p_178394_2_, p_178394_1_));
        return arraylist;
    }
    ...
    private List func_178397_a(TextureAtlasSprite p_178397_1_, String p_178397_2_, int p_178397_3_)
    {
        ...
        ArrayList arraylist = Lists.newArrayList();
        Iterator iterator = this.func_178393_a(p_178397_1_).iterator();

        while (iterator.hasNext())
        {
            ItemModelGenerator.Span span = (ItemModelGenerator.Span)iterator.next();
            float f2 = 0.0F;
            float f3 = 0.0F;
            float f4 = 0.0F;
            float f5 = 0.0F;
            ...
            float f14 = (float)span.func_178381_d();
            ItemModelGenerator.SpanFacing spanfacing = span.func_178383_a();

            switch (ItemModelGenerator.SwitchSpanFacing.values[spanfacing.ordinal()])
            {
                case 1:
                    f6 = f12;
                    f2 = f12;
            ...
            f9 *= f11;
            HashMap hashmap = Maps.newHashMap();
            hashmap.put(spanfacing.getFacing(), new BlockPartFace((EnumFacing)null, p_178397_3_, p_178397_2_, new BlockFaceUV(new float[] {f6, f8, f7, f9}, 0)));

            switch (ItemModelGenerator.SwitchSpanFacing.values[spanfacing.ordinal()])
            {
                case 1:
                    arraylist.add(new BlockPart(new Vector3f(f2, f3, 7.5F), new Vector3f(f4, f3, 8.5F), hashmap, (BlockPartRotation)null, true));
                    break;
                case 2:
                    arraylist.add(new BlockPart(new Vector3f(f2, f5, 7.5F), new Vector3f(f4, f5, 8.5F), hashmap, (BlockPartRotation)null, true));
                    break;
                case 3:
                    arraylist.add(new BlockPart(new Vector3f(f2, f3, 7.5F), new Vector3f(f2, f5, 8.5F), hashmap, (BlockPartRotation)null, true));
                    break;
                case 4:
                    arraylist.add(new BlockPart(new Vector3f(f4, f3, 7.5F), new Vector3f(f4, f5, 8.5F), hashmap, (BlockPartRotation)null, true));
            }
        }
    ...
    {
        boolean flag1 = this.func_178391_a(p_178396_3_, p_178396_4_ + p_178396_1_.func_178372_b(), p_178396_5_ + p_178396_1_.func_178371_c(), p_178396_6_, p_178396_7_) && p_178396_8_;
    ...
    private void func_178395_a(List p_178395_1_, ItemModelGenerator.SpanFacing p_178395_2_, int p_178395_3_, int p_178395_4_)
    {
        ...
        Iterator iterator = p_178395_1_.iterator();

        while (iterator.hasNext())
        {
            ItemModelGenerator.Span span1 = (ItemModelGenerator.Span)iterator.next();

            if (span1.func_178383_a() == p_178395_2_)
            {
                int k = p_178395_2_.func_178369_d() ? p_178395_4_ : p_178395_3_;

                if (span1.func_178381_d() == k)
                {
                    span = span1;
                    break;
                }
        ...
        int l = p_178395_2_.func_178369_d() ? p_178395_4_ : p_178395_3_;
        int i1 = p_178395_2_.func_178369_d() ? p_178395_3_ : p_178395_4_;

        if (span == null)
        {
            p_178395_1_.add(new ItemModelGenerator.Span(p_178395_2_, i1, l));
        }
        else
        {
