...
public class EntityParticleEmitter extends EntityFX
{
    ...
    public void onUpdate()
    {
        for (int i = 0; i < 16; ++i)
        {
            ...
            {
                double d3 = this.field_174851_a.posX + d0 * (double)this.field_174851_a.width / 4.0D;
                double d4 = this.field_174851_a.getEntityBoundingBox().minY + (double)(this.field_174851_a.height / 2.0F) + d1 * (double)this.field_174851_a.height / 4.0D;
                double d5 = this.field_174851_a.posZ + d2 * (double)this.field_174851_a.width / 4.0D;
                this.worldObj.spawnParticle(this.field_174849_az, false, d3, d4, d5, d0, d1 + 0.2D, d2, new int[0]);
            }
        }
