...
public class ItemWoolFleeceChest extends ItemArmor {

	private final String name = "woolfleecechest";
	
	public ItemWoolFleeceChest(ArmorMaterial material, int armorType) {
