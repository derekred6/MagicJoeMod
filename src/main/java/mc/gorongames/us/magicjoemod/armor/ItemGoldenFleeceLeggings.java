...
public class ItemGoldenFleeceLeggings extends ItemArmor {
	
	private final String name = "goldenfleeceleggings";
	
	public ItemGoldenFleeceLeggings(ArmorMaterial material, int armorType) {
...
//		setTextureName(Constants.MODID + ":" + name);
	...
	public String getArmorTexture(ItemStack stack, Entity entity,int slot, String type){
		...
		if(stack.getItem() == ModArmor.goldenfleeceleggingsItem){
