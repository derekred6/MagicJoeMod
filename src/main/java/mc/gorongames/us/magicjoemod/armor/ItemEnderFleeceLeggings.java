...
public class ItemEnderFleeceLeggings extends ItemArmor {
	
	private final String name = "enderfleeceleggings";
	
	public ItemEnderFleeceLeggings(ArmorMaterial material, int armorType) {
...
//		setTextureName(Constants.MODID + ":" + name);
	...
	public String getArmorTexture(ItemStack stack, Entity entity,int slot, String type){
		...
		if(stack.getItem() == ModArmor.enderfleeceleggingsItem){
