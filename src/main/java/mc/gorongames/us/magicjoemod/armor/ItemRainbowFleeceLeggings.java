...
public class ItemRainbowFleeceLeggings extends ItemArmor {
	
	private final String name = "rainbowfleeceleggings";
	
	public ItemRainbowFleeceLeggings(ArmorMaterial material, int armorType) {
...
//		setTextureName(Constants.MODID + ":" + name);
	...
	public String getArmorTexture(ItemStack stack, Entity entity,int slot, String type){
		...
		if(stack.getItem() == ModArmor.rainbowfleeceleggingsItem){
