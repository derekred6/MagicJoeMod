...
public class ItemWoolFleeceLeggings extends ItemArmor {

	private final String name = "woolfleeceleggings";
	
	public ItemWoolFleeceLeggings(ArmorMaterial material, int armorType) {
