...
public class EntityRainbowJoe extends EntitySheep {
	
	public EntityRainbowJoe(World WorldIn) {
...
//	    ((PathNavigateGround)this.getNavigator()).func_179693_d(true); //use for land and water this.richie messed up
	    this.moveHelper = new EntityRainbowJoe.sheepTestMoveHelper();		
	}
...
//    
    ...
    public class sheepTestMoveHelper extends EntityMoveHelper {
		...
		private EntityRainbowJoe entity = EntityRainbowJoe.this;
		private int randcounter;
		
		public sheepTestMoveHelper() {
			
			super(EntityRainbowJoe.this);
