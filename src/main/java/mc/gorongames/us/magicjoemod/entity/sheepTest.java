...
public class sheepTest extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    /**
    ...
    public sheepTest(World worldIn)
    {
        super(worldIn);
        this.setSize(1.0f, 1.0f);
//        this.setSize(0.9F, 1.3F);
//        ((PathNavigateGround)this.getNavigator()).func_179690_a(true); /use for land only
        this.tasks.addTask(0, new SheepAISwimming(this));
        this.tasks.addTask(1, new SheepAIWander(this));
...
//        this.tasks.addTask(6, new EntityAIWander(this, 1.0D));
        ...
        this.moveHelper = new sheepTest.sheepTestMoveHelper();
...
//        }
    ...
    public class sheepTestMoveHelper extends EntityMoveHelper {
		...
		private sheepTest entity = sheepTest.this;
		private int randcounter;
		
		public sheepTestMoveHelper() {
			
			super(sheepTest.this);
