...
import mc.gorongames.us.magicjoemod.entity.layer.ModelGoldenJoeWool;
...
public class LayerJoeWool implements LayerRenderer
{
    ...
    public LayerJoeWool(RenderEntityGoldenJoe p_i46112_1_)
    {
